...
JNIEXPORT jstring JNICALL getParam(JNIEnv * env, jobject obj, jint key) {
...
static JNINativeMethod gMethods[] = { //绑定
		{ "getParam", "(I)Ljava/lang/String;", (void*) getParam }, { "setParam",
				"(I)Z", (void*) Java_com_brunjoy_Setting_setParam }, { "set",
				"(II)Z", (void*) Java_com_brunjoy_Setting_set }, };
;
